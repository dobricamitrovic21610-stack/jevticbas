    ...
    >
      ...
      >
        ...
        <p className="mx-auto mt-3 max-w-md text-sm text-ink-muted">
          Naši projekti sa terena — opis je ispod svake slike.
        </p>
      </motion.div>

      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6 md:grid-cols-3 md:auto-rows-[minmax(14rem,auto)] lg:gap-7">
